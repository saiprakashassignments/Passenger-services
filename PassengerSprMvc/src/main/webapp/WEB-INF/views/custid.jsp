...
<body>
	...
	--%>
	<jsp:useBean id="passenger"
		class="com.imcs.SprMvc.model.passenger_profile" />
	<jsp:setProperty property="*" name="passengers" />
	<table>
		<tr>
			<td>${passengers.profile_id}</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>${passengers.tel_no}</td>
		</tr>
		<tr>

			<td>${passengers.email_id}</td>
		</tr>
	</table>
